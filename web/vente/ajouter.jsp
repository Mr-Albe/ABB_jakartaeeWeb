            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-white/30 transition-all duration-300 hover:shadow-2xl">
                ...
                <div class="px-6 py-8 sm:px-8 sm:py-10">
                    <form action="<%= request.getContextPath()%>/VenteServlet" method="post" class="space-y-6" id="venteForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="quantite" min="0.01" step="0.01" required 
                                ...
                                <!-- Prix unitaire - remplace un champ de l'approvisionnement -->
                                <div class="space-y-2">
                            ...
                            <!-- Colonne de droite - mêmes dimensions -->
                            <div class="space-y-6">
                                <!-- Date - même champ -->
                                <div class="space-y-2">
                        ...
                        <!-- Bouton identique positionné exactement au même endroit -->
                        <div class="pt-4">
