<div class="sidebar bg-blue-800 text-white w-64 flex-shrink-0 flex flex-col">
    ...
    <div class="flex-grow overflow-y-auto">
        <nav class="p-4">
            <div class="mb-8">
                ...
                <!-- Tableau de bord -->
                <a href="#" class="nav-item flex items-center py-2 px-3 rounded hover:bg-blue-700 mb-1 active">
                ...
                <div class="mb-1">
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="#" class="block py-2 px-3 pl-8 rounded hover:bg-blue-700 text-sm">Ajouter une station</a>
            ...
            <div class="mb-8">
                ...
                <div class="mb-1">
                    <button class="dropdown-btn flex items-center w-full py-2 px-3 rounded hover:bg-blue-700">
                        ...
                        <span class="nav-text text-left flex-grow">Paramètres</span>
                        <i class="fas fa-chevron-right dropdown-icon text-xs"></i>
                    </button>
                    <div class="dropdown-container">
                        <a href="#" class="block py-2 px-3 pl-8 rounded hover:bg-blue-700 text-sm">Configuration système</a>
                        <a href="#" class="block py-2 px-3 pl-8 rounded hover:bg-blue-700 text-sm">Tarification</a>
                        <a href="#" class="block py-2 px-3 pl-8 rounded hover:bg-blue-700 text-sm">Sauvegarde</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <div class="p-4 border-t border-blue-700">
        <div class="flex items-center">
            ...
            <a href="#" class="ml-auto text-blue-200 hover:text-white">
